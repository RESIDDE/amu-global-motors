  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden flex flex-col">
      ...
      <header className="p-6 border-b border-white/5 bg-background/50 backdrop-blur-xl z-10 flex items-center gap-4">
        <img src={logo} alt="AMU Global Motors" className="h-10 w-10 rounded-xl object-contain" />
        <h1 className="text-xl font-heading font-bold tracking-tight uppercase tracking-widest">AMU GLOBAL MOTORS <span className="opacity-50">Portal</span></h1>
      </header>
